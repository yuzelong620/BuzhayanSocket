...
public class DynamicReplySendServlet extends HttpServlet{
	
	private static final long serialVersionUID = 1L;
	Logger logger = LoggerFactory.getLogger(DynamicReplySendServlet.class);
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		ResponseMsg msg=ResponseMsg.createMessage(json, CommandId.game_dynamic_send);
