...
public class MessageSendServlet extends HttpServlet {  
	...
	Logger logger = LoggerFactory.getLogger(MessageSendServlet.class);
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		Long userId=obj.getLong("toPlyaerId");
		if(userId==null){
			return;
		}
		ResponseMsg msg=ResponseMsg.createMessage(json, CommandId.game_message_send);
